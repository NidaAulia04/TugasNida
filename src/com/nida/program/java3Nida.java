...
public class java3Nida {
    ...
    dataMahasiswa = new ArrayList<>();
        ...
        dataMahasiswa.add(new Mahasiswa("20200040091", "Nida Aulia"));
        dataMahasiswa.add(new Mahasiswa("20200040092", "Ikhsan Maulana"));
        dataMahasiswa.add(new Mahasiswa("20200040093", "Falya Amrina"));
        
        ArrayList <Buku> dataBuku = new ArrayList<>(); 

    dataBuku.add(new Buku("1", "Logika Informatika"));
    dataBuku.add(new Buku("2", "Cara Ngoding"));
    dataBuku.add(new Buku("3", "Sistem Informasi"));
  ...
  public static void 
    menuMahasiswa(ArrayList <Mahasiswa> dataMahasiswa){
    int keluar = 0;
    Scanner scanner = new Scanner(System.in);
